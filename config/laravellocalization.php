...
return [
    ...
    'supportedLocales' => [
        'ar' => ['name' => 'Arabic', 'script' => 'Arab', 'native' => 'العربية', 'regional' => 'ar_AE', "flag" => "backend/media/flags/saudi-arabia.svg"],
        'en' => ['name' => 'English', 'script' => 'Latn', 'native' => 'English', 'regional' => 'en_GB', "flag" => "backend/media/flags/united-states.svg"],
        ...
        //'ur'          => ['name' => 'Urdu',                   'script' => 'Arab', 'native' => 'اردو', 'regional' => 'ur_PK', "flag" => "backend/media/flags/india.svg"],
