<h2 class="text-center my-5">{{__("You can order Categories by drag and drop")}}</h2>
<div class="row">
                    ...
                    <div class="card-header">
                        <div class="card-title">
                            <h3 class="card-label">
                                ...
                                <input type="hidden" name="categories[]" value="{{$category->id}}" class="products">
                            </h3>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        droppable_{{$random}}.on('drag:stop', (evt) => {
            ...
            setTimeout(function(){
                ...
                axios.post("{{route('admin.save-category-subs-ordering', [$category_id])}}", {'categories': products}).then((response) => {
