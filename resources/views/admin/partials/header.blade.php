...
<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
    <a href="{{ route('admin.login') }}" class="d-lg-none">
        <img alt="Logo" src="{{ \App\Core\Support\Settings::get('site_logo') }}" class="h-30px" />
    </a>
</div>
<div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
    <div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true"
        ...
        <div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0"
            ...
            <a href="{{ route('admin.login') }}" class="menu-item me-0 me-lg-2">
    ...
    <div class="app-navbar flex-shrink-0">
        <div class="app-navbar-item ms-1 ms-md-4">
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-400px" data-kt-menu="true" id="kt_menu_notifications">
                <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('{{asset('backend/media/misc/menu-header-bg.jpg')}}')">
                    <h3 class="text-white fw-semibold px-9 my-5">
                        {{__("Notifications")}} <span class="fs-8 opacity-75 ps-3">{{Auth::user()->unreadNotifications()->count() ?? 0}}</span>
                    </h3>
                </div>
                <div class="scroll-y mh-325px my-5 px-8"  id="notification_data"></div>
                @if(Auth::user()->unreadNotifications()->count() > 10)
                    <div class="py-3 text-center border-top">
                        <a href="{{route('admin.notification.index')}}" class="btn btn-color-gray-600 btn-active-color-primary">
        ...
        <div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
            <div class="cursor-pointer symbol symbol-30px symbol-md-40px"
                data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent"
                data-kt-menu-placement="bottom-end">
                <img src="{{ auth()->user('admin')->profileImage }}" alt="user" />
            </div>
            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                ...
                <div class="menu-item px-5">
                    <a href="{{ route('admin.profile.index') }}"
                        class="menu-link {{ request()->routeIs('admin.profile.index') ? 'active' : '' }} px-5">{{ __('My Profile') }}</a>
                </div>
                @include('admin.partials.backend-languages')
                <div class="menu-item px-5">
                    <a href="javascript:;" class="logout_btn menu-link px-5" >{{ __('Sign Out') }}</a>
                </div>
            </div>
        </div>
